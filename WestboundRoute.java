...
public class WestboundRoute {
    ...
    TrainStop STOP_1 = new TrainStop(1, "Lindenwold", 10, 20, 2, -1);
    TrainStop STOP_2 = new TrainStop(2, "Ashland", 10, 20, 1, 3);
    TrainStop STOP_3 = new TrainStop(3, "Woodcrest", 10, 20, 3, 2);
    TrainStop STOP_4 = new TrainStop(4, "Haddonfield", 10, 20, 2, 3);
    TrainStop STOP_5 = new TrainStop(5, "Westmont", 10, 20, 2, 2);
    TrainStop STOP_6 = new TrainStop(6, "Collingswood", 10, 20, 2, 2);
    TrainStop STOP_7 = new TrainStop(7, "Ferry Avenue", 10, 20, 4, 2); 
    TrainStop STOP_8 = new TrainStop(8, "Broadway", 10, 20, 2, 3);  
    TrainStop STOP_9 = new TrainStop(9, "City Hall", 10, 20, 5, 1);
    TrainStop STOP_10 = new TrainStop(10, "8th & Market St.", 10, 20, 2, 5);
    TrainStop STOP_11 = new TrainStop(11, "9/10th & Locust St.", 10, 20, 1, 2);
